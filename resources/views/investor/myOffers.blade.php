                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-[#161e2d] border border-white/5 rounded-2xl p-8 shadow-xl">
                        <div class="flex justify-between items-start mb-10">
                            <div class="flex items-center space-x-4">
                                <div class="w-12 h-12 bg-[#1e293b] rounded-lg flex items-center justify-center text-brand-green overflow-hidden">
                                    <img src="https://images.unsplash.com/photo-1509391366360-fe5bb65831bb?auto=format&fit=crop&w=100&q=80" class="w-full h-full object-cover">
                                </div>
                                <div>
                        ...
                        <div class="grid grid-cols-3 gap-8 mb-10">
                            ...
                            <div>
                                <div class="text-[9px] font-bold text-gray-500 tracking-widest uppercase mb-2">Valuation</div>
                        ...
                        <div class="flex justify-between items-center">
                            <div class="flex space-x-3">
                                <button class="bg-red-600 text-white px-8 py-2.5 rounded font-bold text-[11px] uppercase tracking-wider">Cancel</button>
                                <button class="bg-[#0b1120] text-gray-300 px-8 py-2.5 rounded font-bold text-[11px] uppercase tracking-wider">View Pitch</button>
                                <button class="bg-[#1e293b] text-brand-green px-8 py-2.5 rounded font-bold text-[11px] uppercase tracking-wider">Edit Terms</button>
                            </div>
                    ...
                    <div class="bg-[#161e2d] border border-white/5 rounded-2xl p-8 shadow-xl">
                        <div class="flex justify-between items-start mb-10">
                            <div class="flex items-center space-x-4">
                                <div class="w-12 h-12 bg-[#1e293b] rounded-lg flex items-center justify-center text-brand-green overflow-hidden">
                                    <img src="https://images.unsplash.com/photo-1677442136019-21780ecad995?auto=format&fit=crop&w=100&q=80" class="w-full h-full object-cover">
                                </div>
                                <div>
                        ...
                        <div class="grid grid-cols-3 gap-8 mb-10">
                            ...
                            <div>
                                <div class="text-[9px] font-bold text-gray-500 tracking-widest uppercase mb-2">Valuation (POST)</div>
                                <div class="text-lg font-bold text-gray-600">$-----</div>
                            </div>
                            <div>
                                <div class="text-[9px] font-bold text-gray-500 tracking-widest uppercase mb-2">Date Sent</div>
                        ...
                        <div class="flex justify-between items-center">
                            <div class="flex space-x-3">
                                <button class="bg-red-600 text-white px-8 py-2.5 rounded font-bold text-[11px] uppercase tracking-wider">Cancel</button>
                                <button class="bg-[#0b1120] text-gray-300 px-8 py-2.5 rounded font-bold text-[11px] uppercase tracking-wider">View Pitch</button>
                                <button class="bg-[#1e293b] text-brand-green px-8 py-2.5 rounded font-bold text-[11px] uppercase tracking-wider">Re-Bid</button>
                                <button class="border border-red-900/30 text-red-900 px-8 py-2.5 rounded font-bold text-[11px] uppercase tracking-wider">Cancel</button>
                            </div>
                            <div class="text-gray-500 font-black text-[10px] tracking-widest uppercase">Pending Offer</div>
                        </div>
                    </div>
                    ...
                    <div class="bg-[#161e2d] border border-white/5 rounded-2xl p-8 shadow-xl">
                        ...
                        <div class="flex justify-between items-center">
                            <div class="flex space-x-3">
                                <button class="bg-red-600 text-white px-8 py-2.5 rounded font-bold text-[11px] uppercase tracking-wider">Cancel</button>
                                <button class="bg-[#0b1120] text-gray-300 px-8 py-2.5 rounded font-bold text-[11px] uppercase tracking-wider">View Pitch</button>
                                <button class="bg-brand-green text-[#064e3b] px-8 py-2.5 rounded font-bold text-[11px] uppercase tracking-wider">Proceed to Agreement</button>
                            </div>
                            <div class="text-gray-500 font-black text-[10px] tracking-widest uppercase">Offer Finalized</div>
                        </div>
                    </div>
