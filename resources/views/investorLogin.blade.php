            ...
            <div class="px-8 py-10 md:px-12 md:py-12">
                ...
                <form action="{{ route('login.post') }}" method="POST" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" required placeholder="investor@investbridge.com" class="w-full bg-[#111625] border border-transparent rounded-sm px-4 py-4 text-sm text-gray-200 placeholder-gray-500 focus:outline-none focus:border-brand-green focus:ring-1 focus:ring-brand-green transition-colors" autocomplete="off">
                    </div>
