        ...
        <main class="flex-1 min-w-0 p-4 sm:p-6 md:p-12">
            <div class="max-w-8xl mx-auto w-full">
                ...
                <div class="mb-8 md:mb-12">
                    <h1 class="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 md:mb-4">Create Your Pitch</h1>
                ...
                <form method="POST" action="{{ route('entrepreneur.pitch.store') }}" enctype="multipart/form-data"
                    ...
                    <div class="space-y-4 md:space-y-6">
                        ...
                        <div id="drop-zone"
                            class="relative w-full aspect-video bg-[#111625] rounded-xl overflow-hidden border border-white/5 group cursor-pointer transition-colors duration-300 min-w-0"
                        ...
                        <div id="pitch-identity-grid" class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 items-end min-w-0">
                            <div class="space-y-2 min-w-0">
                                ...
                                <input type="text" required name="startup_name" value="{{ old('startup_name') }}" placeholder="Enter your startup name"
                                    ...
                                    class="w-full bg-[#0b1120] border border-white/5 rounded px-4 py-3 sm:py-4 focus:outline-none focus:border-brand-green/50 text-sm"
                                    required>
                            </div>
                            <div class="space-y-2 min-w-0">
                            ...
                            <div id="monthly-growth-field" class="space-y-2 min-w-0">
                                ...
                                <div class="flex items-center bg-[#0b1120] border border-white/5 rounded">
                                    <input type="number" required name="monthly_growth" value="{{ old('monthly_growth') }}" placeholder="e.g. 22" min="1"
                                        ...
                                        class="flex-1 min-w-0 bg-transparent px-4 py-3 sm:py-4 focus:outline-none text-sm">
                                    <div class="p-2">
                            ...
                            <div id="add-button-box"
                                class="bg-[#0b1120] border border-white/5 h-[84px] rounded flex items-center justify-center min-w-0">
                    ...
                    <div class="space-y-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" required name="funding_required" value="{{ old('funding_required') }}" placeholder="e.g. Rs 5,000,000"
                                class="w-full bg-[#0b1120] border border-white/5 rounded px-4 py-3 sm:py-4 focus:outline-none focus:border-brand-green/50 text-base sm:text-lg font-bold">
                        </div>
                        <div class="space-y-2">
                    ...
                    <div class="bg-[#0b1120] p-6 sm:p-8 md:p-10 rounded-xl border border-white/5 text-center">
                        ...
                        <div class="flex items-center justify-center space-x-1 sm:space-x-2">
                            ...
                            <input type="text" required name="total_valuation" value="{{ old('total_valuation') }}" placeholder="10,000,000"
                                class="bg-transparent text-3xl sm:text-4xl md:text-5xl font-bold text-brand-green focus:outline-none w-full text-center min-w-0">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-center pb-12">
                <button type="submit"
                    class="bg-[#4ade80] text-[#064e3b] w-full sm:w-auto px-8 sm:px-16 py-4 rounded font-bold text-sm tracking-widest uppercase hover:bg-[#3dbd6d] transition-all shadow-xl shadow-brand-green/10">
                    Publish Pitch
                </button>
            </div>
            </form>
