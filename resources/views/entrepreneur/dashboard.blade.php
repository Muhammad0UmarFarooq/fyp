                ...
                <div class="px-8 pb-12">
                    ...
                    <div class="flex justify-between items-start mb-6">
                        ...
                        <div class="text-right">
                            ...
                            <div class="text-4xl font-bold text-brand-green">Rs {{ number_format($pitch->funding_required ?? 0) }}</div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
                        ...
                        <div class="bg-[#0b1120] p-6 rounded-xl border border-white/5">
                            ...
                            <div class="text-2xl font-bold text-white">Rs {{ number_format($pitch->monthly_net_value) }}</div>
                        </div>
                        @endif
                        ...
                        <div class="bg-[#0b1120] p-6 rounded-xl border border-white/5">
                            ...
                            <div class="text-2xl font-bold text-white">Rs {{ number_format($pitch->total_valuation) }}</div>
                        </div>
                        @endif
