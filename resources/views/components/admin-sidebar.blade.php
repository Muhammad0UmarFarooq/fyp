...
<div id="mobile-sidebar" class="hidden md:hidden fixed inset-0 z-40">
    ...
    <aside class="absolute left-0 top-0 w-64 bg-[#0f1523] border-r border-white/5 h-full flex flex-col py-6 overflow-y-auto z-50">
...
<!-- Desktop Sidebar -->
<aside class="hidden md:flex w-64 bg-[#0f1523] border-r border-white/5 h-[calc(100vh-73px)] sticky top-[73px] flex-col py-6 overflow-y-auto">
    <nav class="flex-1 space-y-2 px-4">
        <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg font-medium text-sm transition-colors {{ request()->routeIs('admin.dashboard') ? 'bg-white/5 text-[#f87171] border-r-2 border-[#f87171]' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
            <span>Dashboard</span>
